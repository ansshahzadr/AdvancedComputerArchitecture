...
lcase_sse_simple(char *restrict dst, const char *restrict src, size_t len)
{
       ...
       for (int i = 0; i < len; i += 128) {
          v = LOAD_SI128((__m128i *)(src + i));
           ...
           v = LOAD_SI128((__m128i *)(src + i + 8));
            STORE_SI128((__m128i *)(dst + i + 8), _mm_or_si128(v,shift));
           v = _mm_loadu_si128((__m128i *)(src + i + 16));
            STORE_SI128((__m128i *)(dst + i + 16), _mm_or_si128(v,shift));
           v = _mm_loadu_si128((__m128i *)(src + i + 24));
            STORE_SI128((__m128i *)(dst + i + 24), _mm_or_si128(v,shift));
           v = _mm_loadu_si128((__m128i *)(src + i + 32));
            STORE_SI128((__m128i *)(dst + i + 32), _mm_or_si128(v,shift));
           v = _mm_loadu_si128((__m128i *)(src + i + 40));
            STORE_SI128((__m128i *)(dst + i + 40), _mm_or_si128(v,shift));
            v = _mm_loadu_si128((__m128i *)(src + i + 48));
            STORE_SI128((__m128i *)(dst + i + 48), _mm_or_si128(v,shift));
            v = _mm_loadu_si128((__m128i *)(src + i + 56));
            STORE_SI128((__m128i *)(dst + i + 56), _mm_or_si128(v,shift));
            v = _mm_loadu_si128((__m128i *)(src + i + 64));
            STORE_SI128((__m128i *)(dst + i + 64), _mm_or_si128(v,shift));
            v = _mm_loadu_si128((__m128i *)(src + i + 72));
            STORE_SI128((__m128i *)(dst + i + 72), _mm_or_si128(v,shift));
            v = _mm_loadu_si128((__m128i *)(src + i + 80));
            STORE_SI128((__m128i *)(dst + i + 80), _mm_or_si128(v,shift));
            v = _mm_loadu_si128((__m128i *)(src + i + 88));
            STORE_SI128((__m128i *)(dst + i + 88), _mm_or_si128(v,shift));
            v = _mm_loadu_si128((__m128i *)(src + i + 96));
            STORE_SI128((__m128i *)(dst + i + 96), _mm_or_si128(v,shift));
            v = _mm_loadu_si128((__m128i *)(src + i + 104));
            STORE_SI128((__m128i *)(dst + i+ 104), _mm_or_si128(v,shift));
            v = _mm_loadu_si128((__m128i *)(src + i + 112));
            STORE_SI128((__m128i *)(dst + i+ 112), _mm_or_si128(v,shift));
            v = _mm_loadu_si128((__m128i *)(src + i + 120));
            STORE_SI128((__m128i *)(dst + i+ 120), _mm_or_si128(v,shift));
        }
